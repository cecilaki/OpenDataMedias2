...
Chacun de ces jeux de données est d'abord évalué par le contributeur (c'est-dire-vous) en répondant à 9 questions en plus de sous-questions.  Après ce processus, les données/informations sont envoyées pour une revision/relecture. il existe pour chaque jeux de données, des expert. Ce qui signifie que les evaluateurs (reviewers) vérifieront les informations soumises par le contributeurs pour chaque pays et chaque jeux de données(ex: dépenses du gouvernement, les données des élections, etc.). 
